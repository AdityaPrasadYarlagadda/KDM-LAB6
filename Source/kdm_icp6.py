...
Original file is located at
    https://colab.research.google.com/drive/1-I0K6z8oqCtP1n-Jch7aYUGQ6jFj1pYn
"""
...
#LDA
ldamodel = gensim.models.ldamodel.LdaModel(corpus, num_topics = 6, id2word=dictionary,iterations=25,offset=1.2,eval_every=25)
#saving the model
ldamodel.save('model_combined.gensim')
topics = ldamodel.print_topics(num_words=3)
print('\n')
print("Now printing the topics and their composition")
print("This output shows the Topic-Words matrix for the 6 topics created and the 3 words within each topic")
for topic in topics:
   print(topic)
